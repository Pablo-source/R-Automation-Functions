...
=======
  # 30/12/2022
  >>>>>>> 3898de79907127591a7da2ac531e96c53c75acd6
...
Subset <-c("London")
<<<<<<< HEAD
Data_sub  <- Mydata %>% filter(City %in% Subset)
...
Subset <-c("London","Barcelona")
<<<<<<< HEAD
Data_sub_excl_two  <- Mydata %>% filter(!City %in% Subset &
                                          =======
